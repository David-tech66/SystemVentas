...
namespace CapaDatos
{
    public class DProducto
    {
        ...
        public DProducto(int id_producto, int id_categoria, int id_marca, string nombre_prod, string descripcion, decimal precio, DateTime fecha_ingreso, string textobuscar) 
        { 
        ...
        public DataTable MostrarProducto()
        {
            ...
            {
                SqlCon.Open();
                SqlCommand SqlCmd = new SqlCommand("spmostrar_producto", SqlCon);   // 2 PARAMETROS: EL NOMBRE DE LA STOREPROCEDURE Y LA CADENA CONEXION
        ...
        public DataTable BuscarProducto(DProducto Producto)
        {
            ...
            {
                SqlCon.Open();
                SqlCommand SqlCmd = new SqlCommand("spbuscar_producto", SqlCon);   // NOMBRE DE STOREPROCEDURE Y LA CADENA CONEXION
                SqlCmd.CommandType = CommandType.StoredProcedure;
                // PARAMETROS SEGUN LA TABLA DE BD
                SqlCmd.Parameters.AddWithValue("@textobuscar", Producto.Textobuscar);
